...
def on_connect(client, userdata, flags, rc):#define the on_connect function with 4 parameters
...
def on_message(client, userdata, msg):#define an on_message function that will ask 3 parameters
